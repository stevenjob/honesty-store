const items = new Map();
items.set('46ced0c0-8815-4ed2-bfb6-40537f5bd512', { name: 'Walkers', price: 50 });
items.set('faeda516-bd9f-41ec-b949-7a676312b0ae', { name: 'N.V. Crunchy Oats & Honey', price: 40 });
