...
export default async ({ branch, secrets: { service: serviceSecret, user: userSecret }, dirs }) => {
    ...
    const userTokenSecret = generateServiceSecret({ branch, liveSecret: userSecret });
