...
const TopupCard = ({ cardDetails, amount, performTopup }) => {
  return (
    <div>
      <p>
        Please check this is the card you want to top up
        {' '}
      ...
      <p className="">
        ...
        >
          Confirm <Currency amount={amount} /> Top Up
        </Link>
      </p>
    </div>
  );
...
const NewCard = ({ amount }) => (
  <div className="">
    <h4>
      No card details to top up
      {' '}
      <Currency amount={amount} />
      {' '}
      from - please add a new card
    </h4>
    <p>
