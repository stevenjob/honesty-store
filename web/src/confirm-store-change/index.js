...
const ConfirmStoreChange = ({
  ...
  <Full>
    ...
    <p>
      ...
      {storeCode}
      {' '}
      (you can always change your association back on the profile screen)?
    </p>
    <p>
      <Link
        className="btn btn-primary"
        onClick={() => performStoreChange({ storeCode })}
      >
        Change to {storeCode}
      </Link>
    </p>
    <p>
      <Link className="btn btn-primary" onClick={() => history.push('/store')}>
        Show {defaultStoreCode}
      </Link>
    </p>
  </Full>
);
...
export default connect(mapStateToProps, { performStoreChange })(
  ConfirmStoreChange
);
