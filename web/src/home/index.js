  ...
  <div className="center navy col-12">
    ...
    <div className="bg-silver py4">
      <div className="col-10 md-col-8 lg-col-6 mx-auto">
        ...
        <p>
          We think vending machines are an outdated, cumbersome and distrustful concept in the modern workplace (and that's when they're working!). We want to do things differently, to save people time and money by offering a cheaper, more engagaing and more convenient way to snack.
        </p>
        <p>
