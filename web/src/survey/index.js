...
const Index = ({ surveyAvailable, count }) => (
  <Full left={<BackToPage path="/store" />}>
    ...
    <p>
      ...
      {count}
      {' '}
      pairs of items and it's up to you to
      {' '}
      <span className="underline">swipe left or right</span>
      {' '}
      to save your favourite item.
    </p>
    {surveyAvailable
      ? <Link to="survey/questions" className="btn btn-primary btn-big">
          Take the Challenge
        </Link>
      : <div to="survey/questions" className="btn bg-gray white btn-big">
